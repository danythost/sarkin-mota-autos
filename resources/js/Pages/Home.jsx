...
export default function Home({ featuredVehicles, brands, featuredGalleries }) {
    ...
    const featuredVideoGallery = featuredGalleries.find(g => g.video_url);

    return (
        <AppLayout>
            <Head title="Home - Sarkin Moto Autos" />

            {/* Premium Animated Background Layer (Fixed) */}
            <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
                ...
                <svg className="absolute inset-0 w-full h-full opacity-[0.08] dark:opacity-[0.15]" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="line-gradient-home" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <div className="relative z-10 transition-colors duration-300">
                ...
                <div className="bg-emerald-900 text-white relative overflow-hidden">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-48 flex flex-col items-center text-center">
                        <span className="inline-block bg-emerald-500/20 backdrop-blur-md border border-emerald-400/30 text-emerald-400 dark:text-emerald-300 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-6 animate-reveal-down transition-all duration-500 hover:bg-emerald-500/30 hover:scale-105 cursor-default">
                            Welcome to Sarkin Mota Autos
                        </span>
                        <h1 className="text-5xl md:text-8xl font-black text-white leading-tight mb-8 animate-reveal-up transition-all duration-700 hover:scale-[1.02] hover:drop-shadow-[0_0_35px_rgba(16,185,129,0.3)] cursor-default">
                            Drive the <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent hover:from-white hover:to-emerald-400 transition-all duration-500">Extraordinary</span>
                        </h1>
                        <div className="max-w-3xl mb-12 animate-reveal-up delay-100">
                            <p className="text-lg md:text-2xl text-gray-200 bg-black/30 backdrop-blur-md p-6 md:p-8 rounded-2xl border border-white/10 shadow-2xl">
                ...
                <div className="bg-white/60 dark:bg-gray-950/60 backdrop-blur-xl py-24 border-t border-gray-100 dark:border-gray-800 relative overflow-hidden transition-colors duration-300">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        ...
                        <div className="animate-zoom-in">
                            <GalleryVideoCard
                                gallery={featuredVideoGallery}
                                videoSrc={featuredVideoGallery ? featuredVideoGallery.video_url : "https://video.wixstatic.com/video/11062b_1ed35c60e58e469595860dd3971e4793/1080p/mp4/file.mp4"}
                            />
                        </div>
                ...
                {/* Brands Section */}
                <div className="bg-slate-50/40 dark:bg-gray-900/40 backdrop-blur-xl py-24 relative overflow-hidden transition-colors duration-300">
                ...
                {/* About Us Section */}
                <section id="about" className="py-24 bg-white/60 dark:bg-gray-950/60 backdrop-blur-xl transition-colors duration-300">
                ...
                <section id="testimonials" className="py-24 bg-gray-50/40 dark:bg-gray-900/40 backdrop-blur-xl overflow-hidden transition-colors duration-300">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Enquiry Section */}
                <section id="enquiry" className="py-24 bg-white/60 dark:bg-gray-950/60 backdrop-blur-sm transition-colors duration-300">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
