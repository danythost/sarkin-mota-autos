                ...
                <div className="w-full max-w-md animate-reveal-up">
                    <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl p-8 sm:p-12 border border-gray-100 dark:border-gray-800 transition-colors">
                        <div className="mb-8 text-center">
                            ...
                            <h2 className="text-3xl font-black text-gray-900 dark:text-white italic uppercase tracking-tighter">Forgot <span className="text-emerald-500">Password?</span></h2>
                        ...
                        {status && (
                            <div className="mb-6 p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-950/20 text-emerald-600 dark:text-emerald-400 text-sm font-bold border border-emerald-100 dark:border-emerald-900/30 animate-reveal-down">
                                {status}
                            </div>
                        )}
